...
void main()
{
    ...
    vec2 _54 = (vec4(OutputSize, 1.0 / OutputSize)).zw * vec2(1.40733301639556884765625, 0.0);
    RA_VARYING_1[1] = RA_VARYING_0 + _54;
    RA_VARYING_1[2] = RA_VARYING_0 - _54;
    vec2 _71 = (vec4(OutputSize, 1.0 / OutputSize)).zw * vec2(3.2942149639129638671875, 0.0);
