...
void main()
{
    ...
    RA_VARYING_0 = (TexCoord * 1.00010001659393310546875) - (vec2(0.0, 0.5) * vec2((vec4(TextureSize, 1.0 / TextureSize)).z, (vec4(TextureSize, 1.0 / TextureSize)).w));
    RA_VARYING_1 = RA_VARYING_0.xyxy + vec4(0.0, -(vec4(TextureSize, 1.0 / TextureSize)).w, 0.0, 0.0);
    RA_VARYING_2 = RA_VARYING_0.xyxy + vec4(0.0, (vec4(TextureSize, 1.0 / TextureSize)).w, 0.0, 2.0 * (vec4(TextureSize, 1.0 / TextureSize)).w);
}
