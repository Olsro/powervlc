...
void main()
{
    ...
    vec4 _1422 = texture2D(Pass6Texture, RA_VARYING_1);
    float _1784;
    if ((mask_type) < 0.5)
    {
    ...
    vec3 _739 = mix(((((_1422.xyz - texture2D(Pass7Texture, RA_VARYING_3).xyz) + ((((((((((_999.xyz * _865) + (_1046.xyz * _862)) + (_1093.xyz * _859)) + (_1140.xyz * _856)) + (_1187.xyz * 1.0)) + (_1234.xyz * _856)) + (_1281.xyz * _859)) + (_1328.xyz * _862)) + (_1375.xyz * _865)) * min(exp(exp(0.3483484089374542236328125 / (RA_VARYING_6 - 0.086058728396892547607421875))), 0.3993345797061920166015625 / RA_VARYING_6))) * _1784) * 2.0) * (levels_contrast), texture2D(Pass5Texture, RA_VARYING_2).xyz * (levels_contrast), vec3((diffusion_weight)));
