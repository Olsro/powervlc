...
void main()
{
    ...
    float _91 = ((width) * (vec4(TextureSize, 1.0 / TextureSize)).x) / (320.0 * (aspect_x));
    RA_VARYING_1 = exp(vec4(1.0, 4.0, 9.0, 16.0) * vec4(((-1.0) / _91) / _91));
}
...
void main()
{
    ...
    vec3 _128 = vec3(RA_VARYING_1.y);
    vec3 _144 = vec3(RA_VARYING_1.x);
    vec3 _217 = ((((((((pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2((-4.0) / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _94) + (pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2((-3.0) / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _111)) + (pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2((-2.0) / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _128)) + (pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2((-1.0) / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _144)) + pow(texture2D(Pass1Texture, RA_VARYING_0).xyz, vec3(2.2000000476837158203125))) + (pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2(1.0 / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _144)) + (pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2(2.0 / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _128)) + (pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2(3.0 / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _111)) + (pow(texture2D(Pass1Texture, RA_VARYING_0 + vec2(4.0 / (vec4(TextureSize, 1.0 / TextureSize)).x, 0.0)).xyz, vec3(2.2000000476837158203125)) * _94);
