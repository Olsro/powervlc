// Generated from crt/shaders/cathode-retro/cathode-retro-util-downsample-2x-vert.slang. See slang/upstream for licence/source.
#version 120
...
const float _64[4] = float[](-2.6764705181121826171875, -0.712341248989105224609375, 0.71234118938446044921875, 2.6764705181121826171875);
const float _78[4] = float[](-0.05099999904632568359375, 0.55099999904632568359375, 0.55099999904632568359375, -0.05099999904632568359375);
...
void main()
{
    ivec2 _117 = ivec2((vec4(TextureSize, 1.0 / TextureSize)).xy);
    vec4 _148;
    _148 = vec4(0.0);
    for (int _147 = 0; _147 < 4; )
    {
        _148 += (texture2D(Texture, RA_VARYING_0 + ((vec2(0.0, 1.0) / vec2(_117)) * _64[_147])) * _78[_147]);
        _147++;
        continue;
    }
    gl_FragData[0] = _148;
