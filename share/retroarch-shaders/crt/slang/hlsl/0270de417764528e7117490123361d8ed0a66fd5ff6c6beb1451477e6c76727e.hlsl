...
void vert_main()
{
    ...
    do
    {
        if (global_interlace_detect_toggle != 0.0f)
        {
            ...
            {
                _330 = (params_SourceSize.y > 1079.5f) && (params_SourceSize.y < 1080.5f);
            }
            else
            {
                _330 = false;
            }
            _332 = ((params_SourceSize.y > 288.5f) && (params_SourceSize.y < 576.5f)) || _330;
            break;
        }
        else
        {
    ...
    il_step_multiple = float2(1.0f, _332 ? 2.0f : 1.0f);
