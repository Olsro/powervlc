...
void frag_main()
{
    ...
    float _66 = _63 * _63;
    float _70 = _66 * _66;
    float3 _106 = Source.Sample(_Source_sampler, _46).xyz;
    float3 _147 = _106 * lerp((params_BRIGHTBOOST - (params_LOWLUMSCAN * (_66 - (2.0499999523162841796875f * _70)))) * (1.0f + (float(frac(floor(vTexCoord.x * params_OutputSize.x) * (-0.33329999446868896484375f)) <= 0.3333300054073333740234375f) * (-params_MASK_DARK))), 1.0f - (params_HILUMSCAN * (_70 - ((2.7999999523162841796875f * _70) * _66))), dot(_106, maskFade.xxx));
    FragColor.x = _147.x;
    FragColor.y = _147.y;
    FragColor.z = _147.z;
}
