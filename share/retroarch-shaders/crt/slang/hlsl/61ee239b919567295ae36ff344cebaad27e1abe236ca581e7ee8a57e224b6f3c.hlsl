// Generated from crt/shaders/newpixie/blur_horiz.slang. See slang/upstream for licence/source.
cbuffer Push : register(b1)
{
    float4 params_OutputSize : packoffset(c2);
    float params_blur_x : packoffset(c3.y);
};
...
void frag_main()
{
    float2 _27 = float2(params_blur_x, 0.0f) * params_OutputSize.zw;
    float _52 = _27.x;
    float _53 = 4.0f * _52;
    float _59 = _27.y;
    float _60 = 4.0f * _59;
