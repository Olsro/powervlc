// Generated from crt/shaders/cathode-retro/cathode-retro-util-gaussian-blur-horz.slang. See slang/upstream for licence/source.
...
Texture2D<float4> g_sourceTex : register(t2);
SamplerState _g_sourceTex_sampler : register(s2);
...
void frag_main()
{
    ...
    {
        _151 += (g_sourceTex.Sample(_g_sourceTex_sampler, vTexCoord + ((float2(1.0f, 0.0f) / float2(_120)) * _62[_150])) * _82[_150]);
        _150++;
        continue;
    }
    FragColor = _151;
