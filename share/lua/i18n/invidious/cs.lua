...
return {
  ...
  btn_combine = "Spojit oba soubory",
  msg_combine_gone = "Oba soubory už nejsou tam, kam byly staženy",
  msg_combine_running = "Spojování… %d %%",
  msg_combine_ok = "Spojování dokončeno: %s",
  msg_combine_failed = "Spojování selhalo — nic nebylo zapsáno",
  msg_combine_unsupported = "Toto sestavení neumí spojit oba soubory",
