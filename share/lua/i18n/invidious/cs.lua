...
return {
  ...
  btn_download_audio = "Stáhnout jen zvuk",
  msg_dl_busy = "Stahování už probíhá — počkejte na ně, nebo je zrušte",
  msg_no_audio_stream = "Toto video nenabízí samostatný zvukový proud",
  btn_dl_cancel = "Zrušit stahování",
  msg_loading_thumb = "Získávání náhledu…",
  dl_preparing = "Příprava stahování…",
  dl_progress = "%s %d %% — soubor %d/%d — %s / %s",
  dl_done = "Stahování dokončeno: %s — v %s",
  dl_done_pair = "Stahování dokončeno: %s (obraz) a %s (zvuk) — v %s. Tato kvalita neexistuje jako sloučený proud: oba soubory patří k sobě.",
  dl_error = "Stahování selhalo: ",
  dl_cancelled = "Stahování zrušeno",
  msg_dl_playlist = "Tato položka je seznam proudů, nikoli soubor: ke stažení vyberte kvalitu s rozlišením",
  msg_dl_unsupported = "Toto sestavení neumí stahovat: chybí mu časovač rozšíření",
  msg_dl_no_dir = "Složku Stažené soubory se nepodařilo najít",
  btn_combine = "Spojit oba soubory pomocí ffmpeg",
  combine_banner = "PowerVLC: spojování obrazu a zvuku, bez překódování.",
  combine_no_ffmpeg = "ffmpeg není nainstalován, nebo není v PATH. Nainstalujte jej a spusťte tento soubor znovu.",
  combine_done = "Hotovo:",
  msg_combine_launched = "ffmpeg spuštěn v okně terminálu — tam je vidět, zda se to povedlo",
  msg_combine_copied = "Terminál se nepodařilo otevřít — příkaz ffmpeg byl zkopírován do schránky",
  msg_combine_fallback = "Terminál se nepodařilo otevřít — příkaz ffmpeg je v poli níže",
  msg_combine_gone = "Oba soubory už nejsou tam, kam byly staženy",
