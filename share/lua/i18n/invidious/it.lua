...
return {
    ...
    btn_combine = "Combina i due file con ffmpeg",
    combine_banner = "PowerVLC: combinazione di immagine e audio, senza ricodifica.",
    combine_no_ffmpeg = "ffmpeg non è installato, o non è nel PATH. Installalo, poi riesegui questo file.",
    combine_done = "Fatto:",
    msg_combine_launched = "ffmpeg avviato in una finestra di terminale — è lì che si vede se ha funzionato",
    msg_combine_copied = "Nessun terminale apribile — il comando ffmpeg è stato copiato negli appunti",
    msg_combine_fallback = "Nessun terminale apribile — il comando ffmpeg è nel campo qui sotto",
