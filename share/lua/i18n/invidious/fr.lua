...
return {
    ...
    btn_combine = "Combiner les deux fichiers",
    ...
    msg_combine_failed = "La combinaison a échoué — rien n'a été écrit",
    msg_combine_unsupported = "Cette version ne sait pas combiner les deux fichiers",
