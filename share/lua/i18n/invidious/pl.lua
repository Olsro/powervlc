...
return {
  ...
  btn_combine = "Połącz oba pliki za pomocą ffmpeg",
  combine_banner = "PowerVLC: łączenie obrazu i dźwięku, bez ponownego kodowania.",
  combine_no_ffmpeg = "ffmpeg nie jest zainstalowany lub nie ma go w PATH. Zainstaluj go i uruchom ten plik ponownie.",
  combine_done = "Gotowe:",
  msg_combine_launched = "ffmpeg uruchomiony w oknie terminala — to tam widać, czy się udało",
  msg_combine_copied = "Nie udało się otworzyć terminala — polecenie ffmpeg skopiowano do schowka",
  msg_combine_fallback = "Nie udało się otworzyć terminala — polecenie ffmpeg jest w polu poniżej",
