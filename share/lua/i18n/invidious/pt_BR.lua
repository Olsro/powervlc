...
return {
    ...
    btn_download = "Baixar",
    btn_download_audio = "Baixar apenas o som",
    msg_dl_busy = "Já há um download em andamento — aguarde ou cancele",
    msg_no_audio_stream = "Este vídeo não oferece nenhum fluxo de som separado",
    btn_dl_cancel = "Cancelar o download",
    msg_loading_thumb = "Obtendo a miniatura…",
    dl_preparing = "Preparando o download…",
    dl_progress = "%s %d %% — arquivo %d/%d — %s / %s",
    dl_done = "Download concluído: %s — em %s",
    dl_done_pair = "Download concluído: %s (imagem) e %s (som) — em %s. Esta qualidade não existe como fluxo combinado: os dois arquivos vão juntos.",
    dl_error = "Falha no download: ",
    dl_cancelled = "Download cancelado",
    msg_dl_playlist = "Esta entrada é uma lista de fluxos, não um arquivo: escolha uma qualidade com resolução para baixá-la",
    msg_dl_unsupported = "Esta versão não sabe baixar: não tem o temporizador de extensões",
    msg_dl_no_dir = "Pasta Downloads não encontrada",
    btn_combine = "Combinar os dois arquivos com o ffmpeg",
    combine_banner = "PowerVLC: combinando imagem e som, sem recodificar.",
    combine_no_ffmpeg = "O ffmpeg não está instalado, ou não está no PATH. Instale-o e execute este arquivo novamente.",
    combine_done = "Concluído:",
    msg_combine_launched = "ffmpeg iniciado em uma janela de terminal — é lá que se vê se deu certo",
    msg_combine_copied = "Nenhum terminal pôde ser aberto — o comando ffmpeg foi copiado para a área de transferência",
    msg_combine_fallback = "Nenhum terminal pôde ser aberto — o comando ffmpeg está no campo abaixo",
    msg_combine_gone = "Os dois arquivos não estão mais onde foram baixados",
