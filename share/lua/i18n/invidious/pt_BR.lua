...
return {
    ...
    btn_combine = "Combinar os dois arquivos",
    msg_combine_gone = "Os dois arquivos não estão mais onde foram baixados",
    msg_combine_running = "Combinando… %d %%",
    msg_combine_ok = "Combinação concluída: %s",
    msg_combine_failed = "A combinação falhou — nada foi gravado",
    msg_combine_unsupported = "Esta versão não consegue combinar os dois arquivos",
