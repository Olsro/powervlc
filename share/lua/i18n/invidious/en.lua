...
return {
    ...
    btn_combine = "Combine the two files with ffmpeg",
    combine_banner = "PowerVLC: combining picture and sound, without re-encoding.",
    combine_no_ffmpeg = "ffmpeg is not installed, or not in the PATH. Install it, then run this file again.",
    combine_done = "Done:",
    msg_combine_launched = "ffmpeg started in a terminal window — it says there whether it worked",
    msg_combine_copied = "No terminal could be opened — the ffmpeg command was copied to the clipboard",
    msg_combine_fallback = "No terminal could be opened — the ffmpeg command is in the field below",
