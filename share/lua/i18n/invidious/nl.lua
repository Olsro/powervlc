...
return {
    ...
    btn_combine = "De twee bestanden met ffmpeg samenvoegen",
    combine_banner = "PowerVLC: beeld en geluid worden samengevoegd, zonder hercodering.",
    combine_no_ffmpeg = "ffmpeg is niet geïnstalleerd, of niet in het PATH. Installeer het en voer dit bestand opnieuw uit.",
    combine_done = "Klaar:",
    msg_combine_launched = "ffmpeg gestart in een terminalvenster — daar staat of het gelukt is",
    msg_combine_copied = "Geen terminal te openen — de ffmpeg-opdracht staat op het klembord",
    msg_combine_fallback = "Geen terminal te openen — de ffmpeg-opdracht staat in het veld hieronder",
