...
return {
    ...
    btn_combine = "Combinar os dois ficheiros",
    msg_combine_gone = "Os dois ficheiros já não estão onde foram transferidos",
    msg_combine_running = "A combinar… %d %%",
    msg_combine_ok = "Combinação concluída: %s",
    msg_combine_failed = "A combinação falhou — não foi escrito nada",
    msg_combine_unsupported = "Esta versão não consegue combinar os dois ficheiros",
