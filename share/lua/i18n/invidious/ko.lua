...
return {
  ...
  btn_combine = "두 파일을 ffmpeg로 합치기",
  combine_banner = "PowerVLC: 다시 인코딩하지 않고 영상과 소리를 합칩니다.",
  combine_no_ffmpeg = "ffmpeg가 설치되어 있지 않거나 PATH에 없습니다. 설치한 뒤 이 파일을 다시 실행하세요.",
  combine_done = "완료:",
  msg_combine_launched = "터미널 창에서 ffmpeg를 시작했습니다 — 성공 여부는 그곳에 표시됩니다",
  msg_combine_copied = "터미널을 열 수 없습니다 — ffmpeg 명령을 클립보드에 복사했습니다",
  msg_combine_fallback = "터미널을 열 수 없습니다 — ffmpeg 명령은 아래 칸에 있습니다",
