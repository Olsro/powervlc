...
return {
  ...
  btn_combine = "Slå ihop de två filerna med ffmpeg",
  combine_banner = "PowerVLC: slår ihop bild och ljud, utan omkodning.",
  combine_no_ffmpeg = "ffmpeg är inte installerat, eller finns inte i PATH. Installera det och kör den här filen igen.",
  combine_done = "Klart:",
  msg_combine_launched = "ffmpeg startat i ett terminalfönster — där syns om det gick bra",
  msg_combine_copied = "Ingen terminal kunde öppnas — ffmpeg-kommandot kopierades till urklipp",
  msg_combine_fallback = "Ingen terminal kunde öppnas — ffmpeg-kommandot står i fältet nedan",
