...
return {
    ...
    btn_combine = "Die beiden Dateien mit ffmpeg zusammenfügen",
    combine_banner = "PowerVLC: Bild und Ton werden zusammengefügt, ohne neu zu kodieren.",
    combine_no_ffmpeg = "ffmpeg ist nicht installiert oder nicht im PATH. Installieren Sie es und starten Sie diese Datei erneut.",
    combine_done = "Fertig:",
    msg_combine_launched = "ffmpeg in einem Terminalfenster gestartet — dort steht, ob es geklappt hat",
    msg_combine_copied = "Es konnte kein Terminal geöffnet werden — der ffmpeg-Befehl liegt in der Zwischenablage",
    msg_combine_fallback = "Es konnte kein Terminal geöffnet werden — der ffmpeg-Befehl steht im Feld unten",
