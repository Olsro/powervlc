...
return {
    ...
    btn_combine = "Combinar los dos archivos",
    msg_combine_gone = "Los dos archivos ya no están donde se descargaron",
    msg_combine_running = "Combinando… %d %%",
    msg_combine_ok = "Combinación terminada: %s",
    msg_combine_failed = "La combinación ha fallado — no se ha escrito nada",
    msg_combine_unsupported = "Esta versión no puede combinar los dos archivos",
