...
return {
  ...
  btn_combine = "İki dosyayı ffmpeg ile birleştir",
  combine_banner = "PowerVLC: görüntü ve ses birleştiriliyor, yeniden kodlamadan.",
  combine_no_ffmpeg = "ffmpeg kurulu değil veya PATH içinde yok. Kurun, sonra bu dosyayı yeniden çalıştırın.",
  combine_done = "Bitti:",
  msg_combine_launched = "ffmpeg bir terminal penceresinde başlatıldı — sonucu orada görürsünüz",
  msg_combine_copied = "Terminal açılamadı — ffmpeg komutu panoya kopyalandı",
  msg_combine_fallback = "Terminal açılamadı — ffmpeg komutu aşağıdaki alanda",
