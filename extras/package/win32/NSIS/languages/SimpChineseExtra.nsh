...
${LangFileString} Desc_Section03 \
    "${PRODUCT_NAME} Mozilla 与 Mozilla Firefox 插件"
${LangFileString} Desc_Section04 \
    "${PRODUCT_NAME} ActiveX 插件"
${LangFileString} Desc_Section05 \
    "DVD 与 CD 回放功能注册"
${LangFileString} Desc_Section06 \
    "将 ${PRODUCT_NAME} 设为指定文件类型的默认程序"
${LangFileString} Desc_Section07 \
    "添加快捷菜单项 (「使用 ${PRODUCT_NAME} 播放」与「添加到 ${PRODUCT_NAME} 播放列表」)"
${LangFileString} Desc_Section08 \
    "删除先前安装版本所留下的 ${PRODUCT_NAME} 偏好设置与缓存文件"

${LangFileString} Name_Section91 "卸载"
${LangFileString} Name_Section92 "删除偏好设置与缓存"

${LangFileString} Desc_Section91 \
"卸载 ${PRODUCT_NAME} 及其全部组件"
${LangFileString} Desc_Section92 \
"删除 ${PRODUCT_NAME} 首选项与缓存文件"

${LangFileString} ShellAssociation_Play "播放"
${LangFileString} ContextMenuEntry_PlayWith "使用 ${PRODUCT_NAME} 播放"
${LangFileString} ContextMenuEntry_AddToPlaylist "添加到 ${PRODUCT_NAME} 播放列表"
...
${LangFileString} MessageBox_VLCRunning "${PRODUCT_NAME} 似乎仍在运行当中，我们现在将关闭它。"
${LangFileString} MessageBox_VLCUnableToClose "安装程序无法自动关闭 ${PRODUCT_NAME}，请手动操作。"
${LangFileString} MessageBox_InstallAborted "安装已中止!"

${LangFileString} Reinstall_Headline "已安装"
${LangFileString} Reinstall_HeadlineInstall "请选择您希望如何安装 ${PRODUCT_NAME}。"
${LangFileString} Reinstall_HeadlineMaintenance "请选择要执行的维护选项。"
${LangFileString} Reinstall_MessageOlder "您的系统中已经安装了较旧版本的 ${PRODUCT_NAME}。请选择您希望执行的操作，并点击“下一步”继续。"
${LangFileString} Reinstall_MessageNewer "已安装较新版本的 ${PRODUCT_NAME}! 建议您不要降级安装旧版本。请选择您希望执行的操作，并点击“下一步”继续。"
${LangFileString} Reinstall_MessageSame "${PRODUCT_NAME} ${VERSION} 已经安装。请选择您希望执行的操作，并点击“下一步”继续。"
${LangFileString} Reinstall_OptionUpgrade "保留先前的设置项，升级 ${PRODUCT_NAME} (推荐)"
${LangFileString} Reinstall_OptionDowngrade "保留先前的设置项，降级 ${PRODUCT_NAME} (推荐)"
${LangFileString} Reinstall_OptionComponents "添加/移除/重新安装组件"
${LangFileString} Reinstall_OptionAdvanced "更改设置 (高级)"
${LangFileString} Reinstall_OptionUninstall "卸载 ${PRODUCT_NAME}"
