...
${LangFileString} Desc_Section03 \
    "L'estensione per Mozilla e Mozilla Firefox di ${PRODUCT_NAME} "
${LangFileString} Desc_Section04 \
    "L'estensione ActiveX di ${PRODUCT_NAME}"
${LangFileString} Desc_Section05 \
    "Riproduzione diretta di DVD e CD"
${LangFileString} Desc_Section06 \
    "Imposta il lettore multimediale ${PRODUCT_NAME} come applicazione predefinita per il tipo di file specificato"
${LangFileString} Desc_Section07 \
    "Aggiunge elementi al menu contestuale ('Riproduci con ${PRODUCT_NAME}' e 'Aggiungi alla scaletta di ${PRODUCT_NAME}')"
${LangFileString} Desc_Section08 \
    "Elimina i file delle preferenze e della cache del lettore ${PRODUCT_NAME} delle precedenti installazioni"

${LangFileString} Name_Section91 "Disinstalla"
${LangFileString} Name_Section92 "Elimina le preferenze e la cache"

${LangFileString} Desc_Section91 \
"Disinstalla il lettore multimediale ${PRODUCT_NAME} e tutti i suoi componenti"
${LangFileString} Desc_Section92 \
"Elimina i file delle preferenze e della cache del lettore multimediale ${PRODUCT_NAME}"

${LangFileString} ShellAssociation_Play "Riproduci"
${LangFileString} ContextMenuEntry_PlayWith "Riproduci con il lettore multimediale ${PRODUCT_NAME}"
${LangFileString} ContextMenuEntry_AddToPlaylist "Aggiungi alla scaletta del lettore multimediale ${PRODUCT_NAME}"
...
${LangFileString} MessageBox_VLCRunning "${PRODUCT_NAME} sembra essere in esecuzione e sarà chiuso subito."
${LangFileString} MessageBox_VLCUnableToClose "L'installatore non è riuscito a chiudere ${PRODUCT_NAME}, chiudilo manualmente."
${LangFileString} MessageBox_InstallAborted "Installazione interrotta!"

${LangFileString} Reinstall_Headline "Già installato"
${LangFileString} Reinstall_HeadlineInstall "Scegli come installare ${PRODUCT_NAME}."
${LangFileString} Reinstall_HeadlineMaintenance "Scegli l'opzione di manutenzione da eseguire."
${LangFileString} Reinstall_MessageOlder "Una versione più datata di ${PRODUCT_NAME} è installata sul tuo sistema. Seleziona l'operazione che desideri eseguire e fai clic su Avanti per continuare."
${LangFileString} Reinstall_MessageNewer "Una versione più recente di ${PRODUCT_NAME} è già installata! Non è consigliato tornare a una versione più datata. Seleziona l'operazione che desideri eseguire e fai clic su Avanti per continuare."
${LangFileString} Reinstall_MessageSame "${PRODUCT_NAME} ${VERSION} è già installato. Seleziona l'operazione che desideri eseguire e fai clic su Avanti per continuare."
${LangFileString} Reinstall_OptionUpgrade "Aggiorna ${PRODUCT_NAME} utilizzando le impostazioni precedenti (consigliata)"
${LangFileString} Reinstall_OptionDowngrade "Torna alla versione più datata di ${PRODUCT_NAME} utilizzando le impostazioni precedenti (consigliato)"
...
${LangFileString} Reinstall_OptionUninstall "Disinstalla ${PRODUCT_NAME}"
