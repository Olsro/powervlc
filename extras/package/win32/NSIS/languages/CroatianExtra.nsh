...
${LangFileString} Desc_Section03 \
    "${PRODUCT_NAME} Mozilla i Mozilla Firefox priključak"
${LangFileString} Desc_Section04 \
    "${PRODUCT_NAME} ActiveX priključak"
${LangFileString} Desc_Section05 \
    "Registracija DVD i CD reprodukcije"
${LangFileString} Desc_Section06 \
    "Postavlja ${PRODUCT_NAME} medijski izvođač kao zadanu aplikaciju za određenu vrstu datoteka"
${LangFileString} Desc_Section07 \
    "Dodaj stavke izbornika sadržaja ('Izvedi s ${PRODUCT_NAME}' i 'Dodaj na ${PRODUCT_NAME} popis izvođenja')"
${LangFileString} Desc_Section08 \
    "Briše osobitosti i datoteke predmemorije zaostale od prijašnje instalacije ${PRODUCT_NAME} medijskog izvođača"

${LangFileString} Name_Section91 "Deinstaliraj"
${LangFileString} Name_Section92 "Obriši osobitosti i predmemoriju"

${LangFileString} Desc_Section91 \
"Deinstaliraj ${PRODUCT_NAME} medijski izvođač i sve njegove komponenete"
${LangFileString} Desc_Section92 \
"Briše osobitosti i datoteke predmemorije ${PRODUCT_NAME} medijskog izvođača"

${LangFileString} ShellAssociation_Play "Reproduciraj"
${LangFileString} ContextMenuEntry_PlayWith "Reproduciraj s ${PRODUCT_NAME} medijskim izvođačem"
${LangFileString} ContextMenuEntry_AddToPlaylist "Dodaj na popis izvođenja ${PRODUCT_NAME} medijskog izvođača"
...
${LangFileString} MessageBox_VLCRunning "Čini se da je ${PRODUCT_NAME} pokrenut i sada će bit zatvoren."
${LangFileString} MessageBox_VLCUnableToClose "Ovaj instalacijski program ne može zatvoriti ${PRODUCT_NAME}, zatvorite ga ručno."
${LangFileString} MessageBox_InstallAborted "Instalacija prekinuta!"

${LangFileString} Reinstall_Headline "Već je instalirano"
${LangFileString} Reinstall_HeadlineInstall "Odaberite kako želite instalirati ${PRODUCT_NAME}."
${LangFileString} Reinstall_HeadlineMaintenance "Odaberite mogućnost održavanja za izvođenje."
${LangFileString} Reinstall_MessageOlder "Starija inačica ${PRODUCT_NAME}-a je instalirana na vaš sustav. Odaberite radnju koju želite izvršiti i kliknite Slijedeće za nastavak."
${LangFileString} Reinstall_MessageNewer "Novija inačica ${PRODUCT_NAME}-a već je instalirana! Nije preporučljivo da instalirate stariju inačicu. Odaberite radnju koju želite izvršiti i kliknite Slijedeće za nastavak."
${LangFileString} Reinstall_MessageSame "${PRODUCT_NAME} ${VERSION} je već instaliran. Odaberite radnju koju želite izvršiti i kliknite Slijedeće za nastavak."
${LangFileString} Reinstall_OptionUpgrade "Nadogradi ${PRODUCT_NAME} koristeći prijašnje postavke (preporučljivo)"
${LangFileString} Reinstall_OptionDowngrade "Vrati stariju inčicu ${PRODUCT_NAME}-a koristeći prijašnje postavke (preporučljivo)"
