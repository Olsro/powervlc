...
${LangFileString} Desc_Section03 \
    "${PRODUCT_NAME} Mozilla va Mozilla Firefox plagini"
${LangFileString} Desc_Section04 \
    "${PRODUCT_NAME} ActiveX plagini"
${LangFileString} Desc_Section05 \
    "DVD va CD’larni ijro etishni ro‘yxatdan o‘tkazish"
${LangFileString} Desc_Section06 \
    "${PRODUCT_NAME} media pleyerni ko‘rsatilgan turdagi fayllar uchun standart dastur sifatida o‘rnatadi"
${LangFileString} Desc_Section07 \
    "Menyu bandi matni qo‘shing (${PRODUCT_NAME} bilan ijro etish va '${PRODUCT_NAME} ijro ro‘yxatiga qo‘shish')"
${LangFileString} Desc_Section08 \
    "${PRODUCT_NAME} media pleyer sozlamalari va oldingi o‘rnatishlga tegishli kesh fayllarini o‘chiradi"

${LangFileString} Name_Section91 "Olib tashlash"
${LangFileString} Name_Section92 "Sozlamalar va keshni o‘chirish"

${LangFileString} Desc_Section91 \
"${PRODUCT_NAME} media pleyer va uning barcha komponentlarini o‘chirish"
${LangFileString} Desc_Section92 \
"${PRODUCT_NAME} media pleyer sozlamalari va kesh fayllarini o‘chiradi"

${LangFileString} ShellAssociation_Play "Ijro etish"
${LangFileString} ContextMenuEntry_PlayWith "${PRODUCT_NAME} media pleyer bilan qo‘yish"
${LangFileString} ContextMenuEntry_AddToPlaylist "${PRODUCT_NAME} media pleyer ijro ro‘yxatiga qo‘shish"
...
${LangFileString} MessageBox_VLCRunning "${PRODUCT_NAME} ishga tushirilganga o‘xhaydi, shuning uchun hozir yopiladi."
${LangFileString} MessageBox_VLCUnableToClose "Ushbu o‘rnatgich ${PRODUCT_NAME}’ni yopa olmaydi. Buni o‘zingiz amalga oshiring."
${LangFileString} MessageBox_InstallAborted "O‘rnatish bekor qilindi!"

${LangFileString} Reinstall_Headline "Allaqachon o‘rnatilgan"
${LangFileString} Reinstall_HeadlineInstall "${PRODUCT_NAME}’ni qanday usulda o‘rnatish kerakligini tanlang."
${LangFileString} Reinstall_HeadlineMaintenance "Bajarish uchun asosiy sozlamalarni tanlang."
${LangFileString} Reinstall_MessageOlder "Tizimingizda ${PRODUCT_NAME}’ning eskiroq versiyasi o‘rnatilgan. Amalga oshirish kerak bo‘lgan jarayonni tanlang va davom etish uchun $\"Keyingi$\" tugmasini bosing."
${LangFileString} Reinstall_MessageNewer "${PRODUCT_NAME}’ning yangiroq versiyasi allaqachon o‘rnatilgan! Eskiroq versiyasiga qaytarish tavsiya qilinmaydi. Amalga oshirish kerak bo‘lgan jarayonni tanlang va davom etish uchun $\"Keyingi$\" tugmasini bosing."
${LangFileString} Reinstall_MessageSame "${PRODUCT_NAME} ${VERSION} allaqachon o‘rnatilgan. Amalga oshirishni xohlagan jarayonlarni tanlang va $\"Keyingi$\" tugmasini bosing."
${LangFileString} Reinstall_OptionUpgrade "${PRODUCT_NAME}’ni oldingi sozlamalari bilan yangilash (tavsiya qilinadi)"
${LangFileString} Reinstall_OptionDowngrade "${PRODUCT_NAME}’ni oldingi sozlamalaridan foydalanib tiklash (tavsiya qilinadi)"
...
${LangFileString} Reinstall_OptionUninstall "${PRODUCT_NAME}’ni o‘chirish"
