...
void FirstRun::buildPrivDialog()
{
    ...
    QLabel *text = new QLabel( qtr(
        "<p>In order to protect your privacy, <i>PowerVLC media player</i> "
        "does <b>not</b> collect personal data or transmit them, "
        "not even in anonymized form, to anyone."
        "</p>\n"
        "<p>Nevertheless, <i>PowerVLC</i> is able to automatically retrieve "
        ...
        "entities. Therefore the <i>PowerVLC</i> developers require your express "
