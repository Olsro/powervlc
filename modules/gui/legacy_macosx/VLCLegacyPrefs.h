...
/* Full port of the VLC 3.0.23 simple preferences: the six panes
 * (Interface, Audio, Video, Subtitles & OSD, Input & Codecs, Hotkeys)
...
@interface VLCLegacyPrefs : NSObject
{
    ...
    NSPopUpButton *languagePopup;           /* NSUserDefaults "language" */
